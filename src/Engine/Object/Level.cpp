...
string Level::AddObject(std::string name, glm::vec3 position)
{
...
void Level::AddPortalPair(Portal& first, Portal& second)
{
...
void Level::AddPortalPair(glm::vec3 position1, glm::vec3 position2)
{
...
void Level::AddPortalPair(glm::mat4 firstPos, glm::mat4 secondPos, float firstYaw /*= -90.0f*/, float secondYaw /*= -90.0f*/)
{
...
std::map<std::string, Object>& Level::GetObjects() { return levelObjects; }

void Level::DeleteObject(std::string id)
{
...
void Level::DrawObjects(Camera& mainCamera, Shader* shader)
{
...
void Level::DrawObjects(Shader* shader)
{
...
void Level::Draw(Camera& mainCamera)
{
...
std::map<std::string /* object ID */, Object> Level::GetObjects() const
{
    return levelObjects;
}

std::map<std::string /* object ID */, Portal>& Level::GetPortals()
{
    return levelPortals;
}

Object* Level::GetObjectPointer(string id)
{
...
Object Level::GetObject(string id)
{
    std::map<std::string /* object ID */, Object>::iterator it = levelObjects.find(id);
    if (it != levelObjects.end())
    {
...
void Level::DrawPortals(Camera& camera)
{
...
Level LevelHandler::ReadLevel(string path, Camera& myCamera, Shader& portalShader, Shader& objectShader)
{
...
void LevelHandler::WriteLevel(string fileName, Level& level, Camera myCamera)
{
...
void LevelHandler::WriteLevel(string fileName, Level& level)
{
