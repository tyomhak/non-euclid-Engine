...
void Portal::SetPair(Portal* _pair) 
{
    pair_portal = _pair; 
}

void Portal::SetShaders(Shader& _objectShader, Shader& _portalShader)
{
...
void Portal::Draw(Camera& mainCamera,
...
void Portal::Draw(Shader& objShader,
    Shader& portShader,
    Camera& mainCamera,
...
Camera Portal::GetPairCamera(Camera& mainCamera) const
{
    glm::mat4 view = mainCamera.GetViewMatrix();
    view = pair_portal->GetWorldMat() * glm::inverse(GetWorldMat()) * glm::inverse(view);
    // view = glm::inverse(view);
